...
window.conjugaisonDataset['participe_present_gerondif'] = {
  ...
  "questions": [
    ...
    {
      "id": "conj-ppg-q2",
      "question": "Les candidats (posséder) _____ une solide expérience dans le secteur associatif seront prioritaires.",
    ...
    {
      "id": "conj-ppg-q3",
      "question": "C'est _____ preuve de patience et _____ un dialogue soutenu qu'ils ont résolu cette crise.",
    ...
    {
      "id": "conj-ppg-q4",
      "question": "Le participe présent irrégulier du verbe 'savoir' est :",
      "prompt": "Le participe présent irrégulier du verbe 'savoir' est :",
      "options": [
        "sachant",
        "savant",
        "sus",
      ...
      "correct": 0,
      "explanation": "Le participe présent et gérondif du verbe savoir se forme de manière irrégulière : 'sachant' (en sachant)."
    }
  ]
};
...
if (typeof window !== 'undefined') {
  ...
  if (!window.grammarDataset.some(function(l) { return l.id === window.conjugaisonDataset['participe_present_gerondif'].id; })) {
    window.grammarDataset.push(window.conjugaisonDataset['participe_present_gerondif']);
  }
}
