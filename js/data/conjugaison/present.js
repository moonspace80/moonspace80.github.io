...
window.conjugaisonDataset['present'] = {
  ...
  "questions": [
    {
      "id": "conj-pres-q1",
      "question": "Pour fluidifier la circulation, la mairie et les urbanistes (aménager) _____ de nouvelles pistes cyclables.",
    ...
    {
      "id": "conj-pres-q2",
      "question": "Nous (commencer) _____ à mesurer les retombées bénéfiques de ce plan de rénovation énergétique.",
    ...
    {
      "id": "conj-pres-q3",
      "question": "Vous (faire) _____ une analyse remarquable des paradoxes économiques actuels.",
    ...
    {
      "id": "conj-pres-q4",
      "question": "Les associations de quartier (intervenir) _____ quotidiennement auprès des publics vulnérables.",
...
if (typeof window !== 'undefined') {
  ...
  if (!window.grammarDataset.some(function(l) { return l.id === window.conjugaisonDataset['present'].id; })) {
    window.grammarDataset.push(window.conjugaisonDataset['present']);
  }
}
