...
const dataFiles = [
  ...
  'expressions_data.js',
  'reading_data.js',
  'listening_data_ep1.js',
  'listening_data_ep2.js',
  'listening_data_ep3.js',
  'listening_data_ep4.js',
  'listening_data_ep5.js',
  'listening_data_ep6.js',
  'listening_data_ep7.js',
  'listening_data_ep8.js',
  'listening_data_ep9.js',
  'listening_data_ep10.js',
  'listening_data_ep11.js',
  'listening_data_ep12.js',
  ...
  'parcours_A1_C2_data.js',
  'parcours_A1_C3_data.js',
  'parcours_A1_C4_data.js',
  'parcours_A1_C5_data.js',
  'parcours_A1_C6_data.js',
  'parcours_A1_C7_data.js',
  'parcours_A1_C8_data.js',
  'parcours_A1_C9_data.js',
  'parcours_A1_C10_data.js',
  'parcours_A1_data.js',
  'parcours_A2_data.js',
  'parcours_B1_data.js',
  'parcours_B2_data.js',
...
assertEqual(window.listeningDataset.length, 15, "listeningDataset has exactly 15 episodes");
...
assertEqual(window.listeningDataset[8].audioUrl, 'audio/rfi_ep_9.mp3', "9th episode audioUrl is audio/rfi_ep_9.mp3");
...
assertEqual(window.listeningDataset[12].audioUrl, 'audio/franceinter_terre_au_carre_20260525.mp3', "13th episode audio is local audio file");
assert(window.listeningDataset[12].questions.length === 5, "13th episode has 5 pedagogical quiz questions");
assertEqual(window.listeningDataset[13].id, 'franceinter-festivals-chaumont-1', "14th episode is France Inter Chaumont-sur-Loire");
assertEqual(window.listeningDataset[13].audioUrl, 'audio/franceinter_chaumont_20260716.mp3', "14th episode audio is local audio file");
assert(window.listeningDataset[13].questions.length === 5, "14th episode has 5 pedagogical quiz questions");
assertEqual(window.listeningDataset[14].id, 'franceinter-bordsdemer-dieppe-1', "15th episode is France Inter Dieppe");
assertEqual(window.listeningDataset[14].audioUrl, 'audio/franceinter_dieppe_20230731.mp3', "15th episode audio is local audio file");
assert(window.listeningDataset[14].questions.length === 5, "15th episode has 5 pedagogical quiz questions");
