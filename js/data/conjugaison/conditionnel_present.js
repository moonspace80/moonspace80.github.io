...
window.conjugaisonDataset['conditionnel_present'] = {
  ...
  "questions": [
    {
      "id": "conj-cp-q1",
      "question": "Si la municipalité consultait davantage les citoyens, elle (éviter) _____ ces vives contestations.",
    ...
    {
      "id": "conj-cp-q2",
      "question": "Pourriez-vous m'accorder un entretien ? Quel est le mode et la valeur de 'Pourriez' ?",
    ...
    {
      "id": "conj-cp-q3",
      "question": "Face à une telle recrudescence de cyberattaques, les entreprises (devoir) _____ renforcer leurs protocoles.",
    ...
    {
      "id": "conj-cp-q4",
      "question": "Si j'avais plus de temps libre, j' (aimer) _____ apprendre une troisième langue vivante.",
      "prompt": "Si j'avais plus de temps libre, j' (aimer) _____ apprendre une troisième langue vivante.",
      "options": [
        "aimerais",
        "aimerai",
        "aimais",
      ...
      "correct": 0,
      "explanation": "L'expression d'un souhait ou potentiel avec 'si + imparfait' demande le conditionnel présent : 'aimerais'."
    }
  ]
};
...
if (typeof window !== 'undefined') {
  ...
  if (!window.grammarDataset.some(function(l) { return l.id === window.conjugaisonDataset['conditionnel_present'].id; })) {
    window.grammarDataset.push(window.conjugaisonDataset['conditionnel_present']);
  }
}
