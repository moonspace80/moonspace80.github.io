...
window.conjugaisonDataset['passe_compose'] = {
  ...
  "questions": [
    {
      "id": "conj-pc-q1",
      "question": "Les conclusions que la commission d'enquête (rédiger) _____ ont été remises au ministre ce matin.",
    ...
    {
      "id": "conj-pc-q2",
      "question": "Après de vives négociations, les deux délégations (parvenir) _____ à un compromis historique.",
    ...
    {
      "id": "conj-pc-q3",
      "question": "Elle s'est (rendre) _____ compte de son erreur après la publication de l'article.",
    ...
    {
      "id": "conj-pc-q4",
      "question": "Ces directives sanitaires, le préfet les (promulguer) _____ dès le début de la crise.",
...
if (typeof window !== 'undefined') {
  ...
  if (!window.grammarDataset.some(function(l) { return l.id === window.conjugaisonDataset['passe_compose'].id; })) {
    window.grammarDataset.push(window.conjugaisonDataset['passe_compose']);
  }
}
